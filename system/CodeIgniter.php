...
class CodeIgniter
{
     ...
     *  php-cli: Invoked by CLI via `php public_html/_index.php`
     *
    ...
    public function run(?RouteCollectionInterface $routes = null, bool $returnResponse = false)
    {
        if ($this->context === null) {
            throw new LogicException(
                ...
                . 'you need to merge `public_html/_index.php` and `spark` file from `vendor/codeigniter4/framework`.'
            );
        }
     ...
     * @return void
     *
     * @deprecated 4.4.0 No longer used. Moved to _index.php and spark.
     */
     ...
     *  2. PHP CLI: accessed by CLI via php public_html/_index.php, arguments become URI segments,
     ...
     * @param int $code
     *
     * @deprecated 4.4.0 No longer Used. Moved to _index.php.
     *
     * @return void
     */
