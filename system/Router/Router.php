...
class Router implements RouterInterface
{
     ...
     * @var string
     */
    protected $indexPage = '_index.php';
    ...
    /**
     * Sets the value that should be used to match the _index.php file. Defaults
     * to _index.php but this allows you to modify it in case you are using
