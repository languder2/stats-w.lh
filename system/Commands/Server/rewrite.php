...
// All request handle by _index.php file.
$_SERVER['SCRIPT_NAME'] = '/_index.php';

// Full path
$path = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . ltrim($uri, '/');

// If $path is an existing file or folder within the public_html folder
...
require_once $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . '_index.php';
