...
class SiteURI extends URI
{
     ...
     * The baseURL "http://localhost:8888/ci431/public_html/" → '/ci431/public_html/'
     */
     ...
     *
     * If the URI is "http://localhost:8888/ci431/public_html/_index.php/test?a=b",
     * and the baseURL is "http://localhost:8888/ci431/public_html/", then:
     *   $baseSegments = [
     *       0 => 'ci431',
     *       1 => 'public_html',
     *       2 => '_index.php',
